...
output_summarized1 <- output_summarized %>%
  plyr::rbind.fill(base_output_summarized) 
...
ggplot(output_summarized_corr, aes(x=factor(decade), y=cvtrip, color = factor(copula)))+
  geom_boxplot() 
...
ggplot(output_summarized_corr, aes(x=factor(decade), y=codcattrip, color = factor(copula)))+
  geom_boxplot() 
...
ggplot(output_summarized_corr, aes(x=factor(decade), y=codkeeptrip, color = factor(copula)))+
  geom_boxplot() 
...
ggplot(output_summarized_corr, aes(x=factor(decade), y=haddcattrip, color = factor(copula)))+
  geom_boxplot() 
...
ggplot(output_summarized_corr, aes(x=factor(decade), y=haddkeeptrip, color = factor(copula)))+
  geom_boxplot() 
...
ggplot(output_summarized_ind, aes(x=factor(decade), y=cvtrip, color = factor(copula)))+
  geom_boxplot() 
```
<div style="margin-bottom:50px;">
</div>
...
ggplot(output_summarized_ind, aes(x=factor(decade), y=codcattrip, color = factor(copula)))+
  geom_boxplot() 
...
ggplot(output_summarized_ind, aes(x=factor(decade), y=codkeeptrip, color = factor(copula)))+
  geom_boxplot() 
...
ggplot(output_summarized_ind, aes(x=factor(decade), y=haddcattrip, color = factor(copula)))+
  geom_boxplot() 
...
ggplot(output_summarized_ind, aes(x=factor(decade), y=haddkeeptrip, color = factor(copula)))+
  geom_boxplot() 
