...
base_output<-read_excel(paste0(output_data_cd,"model_output_orig.xlsx"))  
...
base_output_summarized <- base_output_summarized %>%
  dplyr::mutate(codcattrip=codcat/ntrips, 
                codkeeptrip=codkeep/ntrips, 
                haddcattrip=haddcat/ntrips, 
                haddkeeptrip=haddkeep/ntrips) %>% 
  rename_with(~ paste0(.x, "_corr"), c(codcat, codkeep, codrel, haddcat, haddkeep, haddrel, ntrips, 
                                       codcattrip, codkeeptrip, haddcattrip, haddkeeptrip)) %>% 
    dplyr::mutate(codcat_ind= codcat_corr, 
                  codkeep_ind =codkeep_corr, 
                  codrel_ind =codrel_corr, 
                  haddcat_ind= haddcat_corr, 
                  haddkeep_ind= haddkeep_corr, 
                  haddrel_ind =haddrel_corr, 
                  ntrips_ind= ntrips_corr, 
                  codcattrip_ind=codcattrip_corr,
                  codkeeptrip_ind=codkeeptrip_corr,
                  haddcattrip_ind=haddcattrip_corr,
                  haddkeeptrip_ind=haddkeeptrip_corr)  
...
```{r echo = FALSE,  fig.width=10}
output<-read_excel(paste0(output_data_cd,"model_output_2-14-25.xlsx"))  
