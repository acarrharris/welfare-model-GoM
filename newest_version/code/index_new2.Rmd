...
## Try a plots with al lmeans and sd bars
# library(patchwork)
# 
# # Reorder factor levels so "independent" is first
# output2$copula <- factor(output2$copula,
#                          levels = c("independent", setdiff(unique(output2$copula), "independent")))
# 
# # Compute summary stats (mean ± 1.96*SD) by decade and copula
# summary_stats <- output2 %>%
#   group_by(decade, copula) %>%
#   summarise(
#     cod_mean = mean(codkeep, na.rm = TRUE),
#     cod_sd   = sd(codkeep, na.rm = TRUE),
#     hadd_mean = mean(haddkeep, na.rm = TRUE),
#     hadd_sd   = sd(haddkeep, na.rm = TRUE),
...
# )
# 
# # 1. Monthly bottom temperatures (same as before)
# p1 <- ggplot(projection_temps, aes(month, mean_temp)) +
#   geom_point() +
#   geom_errorbar(aes(ymin = lower, ymax = upper)) +
#   facet_wrap(~decade, nrow = 1) +
...
#   )
# 
# # 2. Cod harvest points + error bars
# p2 <- ggplot(summary_stats, aes(x = copula, y = cod_mean, color = copula)) +
#   geom_point() +
#   geom_errorbar(aes(ymin = cod_mean - 1.96*cod_sd,
#                     ymax = cod_mean + 1.96*cod_sd),
#                 width = 0.2) +
#   facet_wrap(~decade, nrow = 1) +
#   labs(x = NULL, y = "Cod harvest ('000s)") +
#   copula_colors +
#   theme(
#     axis.text.x   = element_blank(),
#     axis.ticks.x  = element_blank(),
...
#   )
# 
# # 3. Haddock harvest points + error bars
# p3 <- ggplot(summary_stats, aes(x = copula, y = hadd_mean, color = copula)) +
#   geom_point() +
#   geom_errorbar(aes(ymin = hadd_mean - 1.96*hadd_sd,
#                     ymax = hadd_mean + 1.96*hadd_sd),
#                 width = 0.2) +
#   facet_wrap(~decade, nrow = 1) +
#   labs(x = NULL, y = "Haddock harvest ('000s)") +
#   copula_colors +
#   theme(
#     axis.text.x   = element_blank(),
#     axis.ticks.x  = element_blank(),
...
#   )
# 
# # 4. Compensating variation points + error bars
# p4 <- ggplot(summary_stats, aes(x = copula, y = cv_mean, color = copula)) +
#   geom_point() +
#   geom_errorbar(aes(ymin = cv_mean - 1.96*cv_sd,
#                     ymax = cv_mean + 1.96*cv_sd),
#                 width = 0.2) +
#   facet_wrap(~decade, nrow = 1) +
#   labs(x = NULL, y = "Compensating variation ($M)") +
#   copula_colors +
#   theme(
#     axis.text.x   = element_blank(),
#     axis.ticks.x  = element_blank(),
