...
### k-tau catch
```{r echo = FALSE, fig.width=10}
ggplot(k_tau_data_comnined, aes(x=decade, y=k_tau_catch_est, color = factor(copula)))+
  geom_boxplot() +
...
### k-tau keep
```{r echo = FALSE, fig.width=10}
ggplot(k_tau_data_comnined, aes(x=decade, y=k_tau_keep_est, color = factor(copula)))+
  geom_boxplot() +
  labs(x = "Decade", y = "Kendall's tau")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
