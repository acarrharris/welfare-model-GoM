...
#  geom_boxplot() 
ggplot(output_summarized_corr_filtered2, aes(x = decade_label, y = codcattrip, color = factor(copula))) +
  geom_boxplot() +
...
ggplot(output_summarized_ind_filtered2, aes(x = decade_label, y = codcattrip, color = factor(copula))) +
  geom_boxplot() +
  coord_cartesian(ylim = c(y_min_cod_cat, y_max_cod_cat)) +
  geom_point(data = historical_point_cod, aes(x = decade_label, y = codcattrip), 
             color = "black", shape = 18, size = 3, inherit.aes = FALSE) +
...
#  geom_boxplot() 
ggplot(output_summarized_corr_filtered2, aes(x = decade_label, y = haddcattrip, color = factor(copula))) +
  geom_boxplot() +
  ...
  geom_point(data = historical_point_hadd, aes(x = decade_label, y = haddcattrip), 
             color = "black", shape = 18, size = 3, inherit.aes = FALSE) +
  labs(x = "", y = "Haddock catch per trip")
...
ggplot(output_summarized_ind_filtered2, aes(x = decade_label, y = haddcattrip, color = factor(copula))) +
  geom_boxplot() +
  coord_cartesian(ylim = c(y_min_hadd_cat, y_max_hadd_cat)) +
  geom_point(data = historical_point_hadd, aes(x = decade_label, y = haddcattrip), 
             color = "black", shape = 18, size = 3, inherit.aes = FALSE) +
