...
## Coastwide decadal projections - welfare (base year = 2021) {.tabset}
...
# k_tau_data_combined_coast_21<-ktau_annual_ind_long %>%
...
ktau_annual<-ktau_data %>% filter(month==0 & domain1 %in% c("ME", "NH", "MA")) %>% 
  ...
  dplyr::mutate(pct_both_above=(both_above/2000)*100)
...
ktau_annual_long <- ktau_annual %>%
  ...
  select(draw, correlation, copula, decade, k_tau_keep_est, k_tau_catch_est, state, pct_both_above)
...
ktau_annual_ind_long <- ktau_annual_ind %>%
  ...
  select(draw, correlation, copula, decade, k_tau_keep_est, k_tau_catch_est, mode, pct_both_above) %>% 
  dplyr::mutate(copula="independent")
...
## Coastwide decadal projections - catch outcomes at the trip level (base year = 2021) {.tabset}
...
### % trips catch both above median
```{r echo = FALSE, fig.width=10}
ggplot(k_tau_data_combined_coast, aes(x=decade, y=pct_both_above, color = factor(copula)))+
  geom_boxplot() +
  labs(x = "Decade", y = "%")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```

## Coastwide decadal projections - catch outcomes at the choice occasion level (base year = 2021) {.tabset}
...
## Coastwide decadal projections - aggregate catch outcomes (base year = 2021) {.tabset}
...
### cod total mortality 
```{r echo = FALSE, fig.width=10}
ggplot(output_summarized1, aes(x=period, y=cod_tot_mort, color = factor(copula)))+
  geom_boxplot() +
...
```{r echo = FALSE, fig.width=10}
ggplot(output_summarized1, aes(x=period, y=hadd_tot_mort, color = factor(copula)))+
  geom_boxplot() +
...
```{r echo = FALSE, fig.width=10}
ggplot(diff, aes(x = factor(decade), y = diff_cod_mort, color = factor(copula))) +
   geom_boxplot() +
...
```{r echo = FALSE, fig.width=10}
ggplot(diff, aes(x = factor(decade), y = diff_hadd_mort, color = factor(copula))) +
   geom_boxplot() +
...
```{r echo = FALSE, fig.width=10}
ggplot(diff, aes(x = factor(decade), y = pct_diff_codkeep, color = factor(copula))) +
   geom_boxplot() +
...
```{r echo = FALSE, fig.width=10}
ggplot(diff, aes(x = factor(decade), y = pct_diff_codcat, color = factor(copula))) +
   geom_boxplot() +
   labs(x = "Decade", y = "% diff in total cod harvest ((corr- ind)/ind)*100")
```
...
```{r echo = FALSE, fig.width=10}
ggplot(diff, aes(x = factor(decade), y = pct_diff_haddkeep, color = factor(copula))) +
   geom_boxplot() +
...
```{r echo = FALSE, fig.width=10}
ggplot(diff, aes(x = factor(decade), y = pct_diff_haddcat, color = factor(copula))) +
   geom_boxplot() +
...
```{r echo = FALSE, fig.width=10}
ggplot(diff, aes(x = factor(decade), y = pct_diff_cod_mort, color = factor(copula))) +
   geom_boxplot() +
...
```{r echo = FALSE, fig.width=10}
ggplot(diff, aes(x = factor(decade), y = pct_diff_cod_hadd_keep, color = factor(copula))) +
   geom_boxplot() +
...
```{r echo = FALSE, fig.width=10}
ggplot(diff, aes(x = factor(decade), y = pct_diff_cod_hadd_cat, color = factor(copula))) +
   geom_boxplot() +
...
## Fishing-mode level decadal projections - welfare (base year = 2021) {.tabset}
...
## Fishing-mode level decadal projections - catch outcomes at the trip level (base year = 2021) {.tabset}
...
## Fishing-mode decadal projections - catch outcomes at the choice occasion level (base year = 2021) {.tabset}
...
## Fishing-mode decadal projections - aggregate catch outcomes (base year = 2021) {.tabset}
...
## State-level decadal projections - welfare (base year = 2021) {.tabset}
...
## State-level  level decadal projections - catch outcomes at the trip level (base year = 2021) {.tabset}
...
## State-level decadal projections - catch outcomes at the choice occasion level (base year = 2021) {.tabset}
...
## State-level decadal projections - aggregate catch outcomes (base year = 2021) {.tabset}
...
## Coastwide decadal projections - welfare (base year = 2020) {.tabset}

Each tab contains different projected fishery outcomes across copula models for the case of dependence, independence, and the difference between dependence and independence. Catch data from 2025-04-17. 
```{r echo = FALSE,  fig.width=10}
# coastwide ktau data 
ktau_data<-read_excel(paste0(output_data_cd,"ktau_output_y2020_6-2-25.xlsx"))
ktau_annual<-ktau_data %>% filter(month==0 & domain1=="all") %>% 
  dplyr::select(-k_tau_catch_p, -k_tau_keep_p, -domain1) %>% 
  dplyr::mutate(pct_both_above=(both_above/2000)*100, pct_both_below=(both_below/2000)*100)
...
ktau_data_ind<-read_excel(paste0(output_data_cd,"ktau_output_y2020_6-2-25_ind.xlsx"))
ktau_annual_ind<-ktau_data_ind %>% filter(month==0 & domain1=="all") %>% 
  dplyr::select(-k_tau_catch_p, -k_tau_keep_p, -domain1)%>% 
  dplyr::mutate(pct_both_above=(both_above/2000)*100, pct_both_below=(both_below/2000)*100)
...
### CV per trip 
```{r echo = FALSE, fig.width=10}
output_summarized1<- read_rds(paste0(output_data_cd,"model_output_y2020_6-2-25_reformat_coast.rds"))  %>%
  dplyr::mutate(codreltrip=codrel/ntrips,
                haddreltrip=haddrel/ntrips, 
                codrelchoice=codrel/n_choice_occasions,
                haddrelchoice=haddrel/n_choice_occasions, 
...
## Coastwide decadal projections - catch outcomes at the trip level (base year = 2020) {.tabset}
...
## Coastwide decadal projections - catch outcomes at the choice occasion level (base year = 2020) {.tabset}
...
## Coastwide decadal projections - aggregate catch outcomes (base year = 2020) {.tabset}
...
## Coastwide decadal projections - welfare (base year = 2019) {.tabset}

Each tab contains different projected fishery outcomes across copula models for the case of dependence, independence, and the difference between dependence and independence. Catch data from 2025-04-17. 
```{r echo = FALSE,  fig.width=10}
# coastwide ktau data 
ktau_data<-read_excel(paste0(output_data_cd,"ktau_output_y2019_6-2-25.xlsx"))
ktau_annual<-ktau_data %>% filter(month==0 & domain1=="all") %>% 
  dplyr::select(-k_tau_catch_p, -k_tau_keep_p, -domain1) %>% 
  dplyr::mutate(pct_both_above=(both_above/2000)*100, pct_both_below=(both_below/2000)*100)
...
ktau_data_ind<-read_excel(paste0(output_data_cd,"ktau_output_y2019_6-2-25_ind.xlsx"))
ktau_annual_ind<-ktau_data_ind %>% filter(month==0 & domain1=="all") %>% 
  dplyr::select(-k_tau_catch_p, -k_tau_keep_p, -domain1)%>% 
  dplyr::mutate(pct_both_above=(both_above/2000)*100, pct_both_below=(both_below/2000)*100)
...
### CV per trip 
```{r echo = FALSE, fig.width=10}
output_summarized1<- read_rds(paste0(output_data_cd,"model_output_y2019_6-2-25_reformat_coast.rds"))  %>%
  dplyr::mutate(codreltrip=codrel/ntrips,
                haddreltrip=haddrel/ntrips, 
                codrelchoice=codrel/n_choice_occasions,
                haddrelchoice=haddrel/n_choice_occasions, 
...
## Coastwide decadal projections - catch outcomes at the trip level (base year = 2019) {.tabset}
...
## Coastwide decadal projections - catch outcomes at the choice occasion level (base year = 2019) {.tabset}
...
## Coastwide decadal projections - aggregate catch outcomes (base year = 2019) {.tabset}
